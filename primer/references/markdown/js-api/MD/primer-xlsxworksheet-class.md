...
* [AddImage](primer-xlsxworksheet-class.md#XlsxWorksheet::AddImage)(row*[integer]*, column*[integer]*, filename*[string]*, x\_scale (optional)*[real]*, y\_scale (optional)*[real]*)
* [AddNumber](primer-xlsxworksheet-class.md#XlsxWorksheet::AddNumber)(row*[integer]*, column*[integer]*, value*[number]*)
* [AddText](primer-xlsxworksheet-class.md#XlsxWorksheet::AddText)(row*[integer]*, column*[integer]*, text*[string]*)
* [SetColumnProperties](primer-xlsxworksheet-class.md#XlsxWorksheet::SetColumnProperties)(column*[integer]*, width*[number]*)
* [SetRowProperties](primer-xlsxworksheet-class.md#XlsxWorksheet::SetRowProperties)(row*[integer]*, height*[number]*)

| Constructor
new XlsxWorksheet(workbook*[[XlsxWorkbook](primer-xlsxworkbook-class.md) object]*, name (optional)*[string]*)

Description<br>Create a new [XlsxWorksheet](primer-xlsxworksheet-class.md) object for writing xlsx files. |
| --- |

#### Arguments

* workbook ([XlsxWorkbook](primer-xlsxworkbook-class.md) object)
...
| Returns
<br>[XlsxWorksheet](primer-xlsxworksheet-class.md) object<br>
Return type
<br>XlsxWorksheet |
| --- |
...
Description<br>Add an image to the Xlsx file. Note that the image will not actually be read/inserted until the workbook is written by calling<br>[XlsxWorkbook.Close](primer-xlsxworkbook-class.md#XlsxWorkbook::Close) so you must make sure the image file exists until then. |
| --- |
