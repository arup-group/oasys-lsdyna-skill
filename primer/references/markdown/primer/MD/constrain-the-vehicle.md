...
Select "Create \*CONSTRAINED\_EXTRA\_NODE" option as shown below in red highlighted box (2) to constrain the vehicle with a rigid plate using \*CONSTRAINED\_EXTRA\_NODES. Use "Constrained extra node set" to provide a node set for \*CONSTRAINED\_EXTRA\_NODES.
