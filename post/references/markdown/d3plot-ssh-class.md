...
The Ssh class allows you to connect to a remote computer using ssh, scp and sftp commands. [More...](d3plot-ssh-class.md#Ssh_details)
...
* [AuthenticateWithPassword](d3plot-ssh-class.md#Ssh::AuthenticateWithPassword)(password*[string]*)
* [AuthenticateWithPublicKey](d3plot-ssh-class.md#Ssh::AuthenticateWithPublicKey)(passphrase (optional)*[string]*)
* [Execute](d3plot-ssh-class.md#Ssh::Execute)(data*[object]*)
* [Get](d3plot-ssh-class.md#Ssh::Get)(remote*[string]*, local*[string]*)
* [Put](d3plot-ssh-class.md#Ssh::Put)(remote*[string]*, local*[string]*)
* [SftpGet](d3plot-ssh-class.md#Ssh::SftpGet)(remote*[string]*, local*[string]*)
* [SftpList](d3plot-ssh-class.md#Ssh::SftpList)(remote*[string]*)
* [SftpMkdir](d3plot-ssh-class.md#Ssh::SftpMkdir)(remote*[string]*, mode*[constant]*)
* [SftpPut](d3plot-ssh-class.md#Ssh::SftpPut)(remote*[string]*, local*[string]*)
* [SftpRmdir](d3plot-ssh-class.md#Ssh::SftpRmdir)(remote*[string]*)
...
| Returns
<br>[Ssh](d3plot-ssh-class.md) object<br>
Return type
<br>Ssh |
| --- |
...
| info | constant | Bitwise information for the file/directory. See the [permissions](d3plot-ssh-class.md#Ssh_permissions_constants), [file types](d3plot-ssh-class.md#Ssh_file_types_constants) and [file bits](d3plot-ssh-class.md#Ssh_file_bits_constants) constants |
...
The mode/permissions for the directory. See the [permissions](d3plot-ssh-class.md#Ssh_permissions_constants) constants for details.
