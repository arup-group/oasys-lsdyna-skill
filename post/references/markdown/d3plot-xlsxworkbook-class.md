...
The XlsxWorkbook class enables writing xlsx files. [More...](d3plot-xlsxworkbook-class.md#XlsxWorkbook_details)
...
* [Close](d3plot-xlsxworkbook-class.md#XlsxWorkbook::Close)()
...
Description<br>Create a new [XlsxWorkbook](d3plot-xlsxworkbook-class.md) object for writing xlsx files. |
| --- |
...
| Returns
<br>[XlsxWorkbook](d3plot-xlsxworkbook-class.md) object<br>
Return type
<br>XlsxWorkbook |
| --- |
