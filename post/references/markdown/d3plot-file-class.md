...
The File class allows you to read and write text files. [More...](d3plot-file-class.md#File_details)
...
* [Copy](d3plot-file-class.md#File::Copy)(source*[string]*, dest*[string]*)
* [Delete](d3plot-file-class.md#File::Delete)(filename*[string]*)
* [DriveMapFilename](d3plot-file-class.md#File::DriveMapFilename)(filename*[string]*, format*[constant]*)
* [Exists](d3plot-file-class.md#File::Exists)(filename*[string]*)
* [FindFiles](d3plot-file-class.md#File::FindFiles)(directory*[string]*, type (optional)*[constant]*)
* [Get](d3plot-file-class.md#File::Get)(url*[string]*, filename*[string]*, options (optional)*[object]*)
* [IsAbsolute](d3plot-file-class.md#File::IsAbsolute)(filename*[string]*)
* [IsDirectory](d3plot-file-class.md#File::IsDirectory)(filename*[string]*)
* [IsFile](d3plot-file-class.md#File::IsFile)(filename*[string]*)
* [IsReadable](d3plot-file-class.md#File::IsReadable)(filename*[string]*)
* [IsWritable](d3plot-file-class.md#File::IsWritable)(filename*[string]*)
* [Mkdir](d3plot-file-class.md#File::Mkdir)(directory*[string]*)
* [Mktemp](d3plot-file-class.md#File::Mktemp)()
* [Proxy](d3plot-file-class.md#File::Proxy)(name*[string]*)
* [ProxyPassword](d3plot-file-class.md#File::ProxyPassword)(name*[string]*)
* [ProxyUsername](d3plot-file-class.md#File::ProxyUsername)(username*[string]*)
* [ReadCSV](d3plot-file-class.md#File::ReadCSV)(filename*[string]*, delimiter (optional)*[string]*, comment (optional)*[string]*)
* [Rename](d3plot-file-class.md#File::Rename)(oldname*[string]*, newname*[string]*)
* [Size](d3plot-file-class.md#File::Size)(filename*[string]*)
* [Upload](d3plot-file-class.md#File::Upload)(filename*[string]*, url*[string]*, options (optional)*[object]*)

## Member functions

* [Close](d3plot-file-class.md#File::Close)()
* [FindLineContaining](d3plot-file-class.md#File::FindLineContaining)(contain*[string]*)
* [FindLineStarting](d3plot-file-class.md#File::FindLineStarting)(start*[string]*)
* [Flush](d3plot-file-class.md#File::Flush)()
* [ReadAll](d3plot-file-class.md#File::ReadAll)()
* [ReadArrayBuffer](d3plot-file-class.md#File::ReadArrayBuffer)(length (optional)*[integer]*)
* [ReadChar](d3plot-file-class.md#File::ReadChar)()
* [ReadLine](d3plot-file-class.md#File::ReadLine)()
* [ReadLongLine](d3plot-file-class.md#File::ReadLongLine)()
* [Seek](d3plot-file-class.md#File::Seek)(offset*[integer]*, origin (optional)*[constant]*)
* [Tell](d3plot-file-class.md#File::Tell)()
* [Write](d3plot-file-class.md#File::Write)(string*[Any valid javascript type]*)
* [WriteArrayBuffer](d3plot-file-class.md#File::WriteArrayBuffer)(buffer*[[ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects)]*, length (optional)*[integer]*)
* [Writeln](d3plot-file-class.md#File::Writeln)(string*[Any valid javascript type]*)
...
| mode (read only) | constant | Mode the file was opened with ([File.READ](d3plot-file-class.md#File.READ), [File.WRITE](d3plot-file-class.md#File.WRITE) etc) |
...
Description<br>Create a new [File](d3plot-file-class.md) object for reading and writing text files. |
| --- |
...
Filename of the file you want to read/write. If reading, the file must exist. If writing, the file will be overwritten (if it exists) if mode is File.WRITE, or if mode is File.APPEND it will be appended to if it exists, or created if it does not.
 When reading a file the filename can also be a URL (uniform resource locator) in which case the file will be read from the remote site. See [File.Get()](d3plot-file-class.md#File::Get) for more details on the format of the URL.

* mode (constant)
 
The mode to open the file with. Can be [File.READ](d3plot-file-class.md#File.READ), [File.WRITE](d3plot-file-class.md#File.WRITE) or [File.APPEND](d3plot-file-class.md#File.APPEND). For [File.WRITE](d3plot-file-class.md#File.WRITE) or [File.APPEND](d3plot-file-class.md#File.APPEND) it can also be ORed with [File.BINARY](d3plot-file-class.md#File.BINARY) if required. By default text is read and written as ASCII. To read/write text in utf-8 mode can also be ORed with [File.UTF8](d3plot-file-class.md#File.UTF8) if required.

| Returns
<br>[File](d3plot-file-class.md) object<br>
Return type
<br>File |
| --- |
...
Description<br>Close a file opened by a [File](d3plot-file-class.md) object. |
| --- |
...
| Example
<br>To close [File](d3plot-file-class.md) object f.<br>
```
f.Close();
```
 |
...
The format for the file/directory name. Can be [Include.NATIVE](d3plot-include-class.md#Include.NATIVE), [Include.UNIX](d3plot-include-class.md#Include.UNIX) or [Include.WINDOWS](d3plot-include-class.md#Include.WINDOWS)
...
| Example
<br>If D3PLOT has drive S: mapped to "/data" (by using the primer\*drive\_s, this\*drive\_s, d3plot\*drive\_s or oasys\*drive\_s preference)<br>
```
...
Description<br>Check if a file exists. See also [File.IsDirectory()](d3plot-file-class.md#File::IsDirectory) and See also [File.IsFile()](d3plot-file-class.md#File::IsFile). |
| --- |
...
Type of things to find. Can be bitwise OR of [File.FILE](d3plot-file-class.md) and [File.DIRECTORY](d3plot-file-class.md). If omitted only files will be returned.
...
Description<br>Reads a line from a file which contains **contain**, opened for reading by a [File](d3plot-file-class.md) object.<br>Although this is possible using core JavaScript functions this function should be significantly faster as<br>most of the processing is done by PRIMER in C rather than in the JavaScript interpreter.<br>To enable this function to be as fast as possible a maximum line length of 512 characters is used. If<br>you expect a file to have lines longer than 512 characters then use<br>[ReadLongLine](d3plot-file-class.md#File::ReadLongLine) which allows lines<br>of any length. If one argument is used then the line must contain that string. If more than one argument is used<br>then lines which contain any of the arguments will be returned |
| --- |
...
| Example
<br>Loop, reading lines from [File](d3plot-file-class.md) object f which contain 'example'.<br>
```
...
Description<br>Reads a line from a file which starts with start, opened for reading by a [File](d3plot-file-class.md) object.<br>Although this is possible using core JavaScript functions this function should be significantly faster as<br>most of the processing is done by PRIMER in C rather than in the JavaScript interpreter.<br>To enable this function to be as fast as possible a maximum line length of 512 characters is used. If<br>you expect a file to have lines longer than 512 characters then use<br>[ReadLongLine](d3plot-file-class.md#File::ReadLongLine) which allows lines<br>of any length. If one argument is used then the line must start with that string. If more than one argument is used<br>then lines which start with any of the arguments will be returned |
| --- |
...
| Example
<br>Loop, reading lines from [File](d3plot-file-class.md) object f which start 'example'.<br>
```
...
Description<br>Flushes a file opened for writing by a [File](d3plot-file-class.md) object. |
| --- |
...
| Example
<br>To flush [File](d3plot-file-class.md) object f.<br>
```
f.Flush();
```
 |
...
Description<br>Get a file from a remote location. See also [File.Proxy()](d3plot-file-class.md#File::Proxy), [File.ProxyPassword()](d3plot-file-class.md#File::ProxyPassword) and [File.ProxyUsername()](d3plot-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Check if a filename is a directory. See also [File.Exists()](d3plot-file-class.md#File::Exists), [File.IsFile()](d3plot-file-class.md#File::IsFile), [File.IsReadable()](d3plot-file-class.md#File::IsReadable) and [File.IsWritable()](d3plot-file-class.md#File::IsWritable). |
| --- |
...
Description<br>Check if a filename is a file. See also [File.Exists()](d3plot-file-class.md#File::Exists), [File.IsDirectory()](d3plot-file-class.md#File::IsDirectory), [File.IsReadable()](d3plot-file-class.md#File::IsReadable) and [File.IsWritable()](d3plot-file-class.md#File::IsWritable). |
| --- |
...
Description<br>Check if a filename has read permissions. See also [File.Exists()](d3plot-file-class.md#File::Exists), [File.IsDirectory()](d3plot-file-class.md#File::IsDirectory) and [File.IsWritable()](d3plot-file-class.md#File::IsWritable). |
| --- |
...
Description<br>Check if a filename has write permissions. If *filename* exists and it is a file then it is checked to see if it can be opened with write (File.APPEND permissions). If *filename* exists and it is a directory<br>then the directory is checked for write permission (can files be created in the directory).<br>If *filename* does not exist then it is assumed to be a file and is checked to see if it can be opened for writing (File.WRITE permissions). See also [File.Exists()](d3plot-file-class.md#File::Exists), [File.IsDirectory()](d3plot-file-class.md#File::IsDirectory) and [File.IsReadable()](d3plot-file-class.md#File::IsReadable). |
| --- |
...
Description<br>Set a proxy for files opened by http, ftp etc. See also [File.Get()](d3plot-file-class.md#File::Get), [File.ProxyPassword()](d3plot-file-class.md#File::ProxyPassword) and [File.ProxyUsername()](d3plot-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Set a proxy password for files opened by http, ftp etc. See also [File.Get()](d3plot-file-class.md#File::Get), [File.Proxy()](d3plot-file-class.md#File::Proxy) and [File.ProxyUsername()](d3plot-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Set a proxy username for files opened by http, ftp etc. See also [File.Get()](d3plot-file-class.md#File::Get), [File.Proxy()](d3plot-file-class.md#File::Proxy) and [File.ProxyPassword()](d3plot-file-class.md#File::ProxyPassword). |
| --- |
...
Description<br>Reads **all** the remaining characters from a file opened for reading by a [File](d3plot-file-class.md) object. As this function can read the entire file as a string be careful when reading large files as it will consume large amounts of memory. |
| --- |
...
| Example
<br>Read all characters from [File](d3plot-file-class.md) object f.<br>
```
 var c = f.ReadAll();
```
 |
...
| Example
<br>To read data as 32bit unsigned integers from [File](d3plot-file-class.md) object f.<br>
```
...
Description<br>Reads a single character from a file opened for reading by a [File](d3plot-file-class.md) object. |
| --- |
...
| Example
<br>Loop, reading characters from [File](d3plot-file-class.md) object f.<br>
```
...
Description<br>Reads a line from a file opened for reading by a [File](d3plot-file-class.md) object. To enable this function to be as fast as possible a maximum line length of 512 characters is used. If you expect a file to have lines longer than 512 characters then use [ReadLongLine](d3plot-file-class.md#File::ReadLongLine) which allows lines of any length. |
| --- |
...
| Example
<br>Loop, reading lines from [File](d3plot-file-class.md) object f.<br>
```
...
Description<br>Reads a line from a file opened for reading by a [File](d3plot-file-class.md) object. The line can be any length. If your file has lines shorter than 512 characters then you may want to use [ReadLine](d3plot-file-class.md#File::ReadLine) instead which is faster. |
| --- |
...
Description<br>Set the current position for reading or writing in a [File](d3plot-file-class.md) object. |
| --- |
...
Origin for offset. Must be one of [File.START](d3plot-file-class.md#File.START), [File.END](d3plot-file-class.md#File.END) or [File.CURRENT](d3plot-file-class.md#File.CURRENT). If omitted [File.START](d3plot-file-class.md#File.START) will be used.
...
| Example
<br>To seek to the end of [File](d3plot-file-class.md) f:<br>
```
f.Seek(0, File.END);
```
<br><br>To seek to the beginning of [File](d3plot-file-class.md) f:<br>
```
f.Seek(0, File.START);
```
<br><br>To move forward 10 characters in [File](d3plot-file-class.md) f:<br>
```
...
Description<br>Return the current file position for a [File](d3plot-file-class.md) object.<br>Note that on Windows when reading files if the file is not opened with [File.BINARY](d3plot-file-class.md#File.BINARY)<br>this may not return the correct file position for files with unix line endings. |
| --- |
...
| Example
<br>To get the current file position for [File](d3plot-file-class.md) f:<br>
```
var pos = f.Tell();
```
 |
...
Description<br>Uploads a file to a remote location. See also [File.Proxy()](d3plot-file-class.md#File::Proxy), [File.ProxyPassword()](d3plot-file-class.md#File::ProxyPassword) and [File.ProxyUsername()](d3plot-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Write a string to a file opened for writing by a [File](d3plot-file-class.md) object. **Note that a carriage return is not added**. |
| --- |
...
| Example
<br>To write string "Hello, world!" to [File](d3plot-file-class.md) object f<br>
```
f.Write("Hello, world!\n");
```
<br>To write the title of model m to [File](d3plot-file-class.md) object f<br>
```
...
Description<br>Writes binary data to a file opened for writing by a [File](d3plot-file-class.md) object. The data to write is an [ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects) object. For more details on how to use an [ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects) see the following links:<br> [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Typed_arrays](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Typed_arrays)<br> [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)<br> [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray)<br> [https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView). |
| --- |
...
| Example
<br>To write [ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects) ab to [File](d3plot-file-class.md) object f.<br>
```
...
Description<br>Write a string to a file opened for writing by a [File](d3plot-file-class.md) object **adding a carriage return**. |
| --- |
...
| Example
<br>To write string "Hello, world!" to [File](d3plot-file-class.md) object f automatically adding a carriage return<br>
```
f.Writeln("Hello, world!");
```
<br>To write the title of model m to [File](d3plot-file-class.md) object f automatically adding a carriage return<br>
```
