...
The XMLParser class enables reading data from XML files. [More...](this-xmlparser-class.md#XMLParser_details)
...
* [Parse](this-xmlparser-class.md#XMLParser::Parse)(filename*[string]*)
...
| Detailed Description<br>The XMLParser class provides a stream-oriented parser to enable you to read XML files. You register callback (or handler) functions with the parser and then parse the document. As the parser recognizes parts of the document, it will call the appropriate handler for that part (if you've registered one.) The document is fed to the parser in pieces. This allows you to parse really huge documents that won't fit into memory.<br> There are currently 6 handlers which can be set: [XMLParser.startElementHandler](this-xmlparser-class.md#startElementHandler), [XMLParser.endElementHandler](this-xmlparser-class.md#endElementHandler), [XMLParser.characterDataHandler](this-xmlparser-class.md#characterDataHandler), [XMLParser.commentHandler](this-xmlparser-class.md#commentHandler), [XMLParser.startCDATAHandler](this-xmlparser-class.md#startCDATAHandler) and [XMLParser.endCDATAHandler](this-xmlparser-class.md#endCDATAHandler). <br>The following simple example shows how the parser could be used.<br> |
| --- |
...
Description<br>Create a new [XMLParser](this-xmlparser-class.md) object for reading XML files. |
| --- |
...
| Returns
<br>[XMLParser](this-xmlparser-class.md) object<br>
Return type
<br>XMLParser |
| --- |
