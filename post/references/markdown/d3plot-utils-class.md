...
The Utils class contains various useful utility functions. [More...](d3plot-utils-class.md#Utils_details)
...
* [Ascii85Decode](d3plot-utils-class.md#Utils::Ascii85Decode)(encoded*[string]*)
* [Ascii85Encode](d3plot-utils-class.md#Utils::Ascii85Encode)(data*[[ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects)]*, length (optional)*[integer]*)
* [Build](d3plot-utils-class.md#Utils::Build)()
* [CallPromiseHandlers](d3plot-utils-class.md#Utils::CallPromiseHandlers)()
* [CheckinLicense](d3plot-utils-class.md#Utils::CheckinLicense)(feature*[string]*)
* [CheckoutLicense](d3plot-utils-class.md#Utils::CheckoutLicense)(feature*[string]*)
* [GarbageCollect](d3plot-utils-class.md#Utils::GarbageCollect)()
* [HTMLBrowser](d3plot-utils-class.md#Utils::HTMLBrowser)()
* [HiResTimer](d3plot-utils-class.md#Utils::HiResTimer)()
* [PdfReader](d3plot-utils-class.md#Utils::PdfReader)()
* [SHA256](d3plot-utils-class.md#Utils::SHA256)(filename*[string]*)
* [SHA512](d3plot-utils-class.md#Utils::SHA512)(filename*[string]*)
* [TimerResolution](d3plot-utils-class.md#Utils::TimerResolution)()
* [UUID](d3plot-utils-class.md#Utils::UUID)()
* [Version](d3plot-utils-class.md#Utils::Version)()
...
Description<br>Decodes an ASCII85 encoded string. See [Utils.Ascii85Encode()](d3plot-utils-class.md#Utils::Ascii85Encode) for details on the method. |
| --- |
...
Description<br>Returns the resolution (precision) of the [Utils.HiResTimer()](d3plot-utils-class.md#Utils::HiResTimer) timer in nanoseconds |
| --- |
