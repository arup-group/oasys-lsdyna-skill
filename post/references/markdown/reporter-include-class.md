...
The Include class allows you to access the include files in a model. [More...](reporter-include-class.md#Include_details)
...
| Detailed Description<br>Originally developed for use in PRIMER, the Include class allows a user to create and query include files in a model. A stripped-back version of this class has been added to T/HIS and REPORTER for consistency between the programs. See [File.DriveMapFilename](reporter-file-class.md#File::DriveMapFilename) for the current use of this class in REPORTER. |
| --- |