...
The Workflow class allows you to read and write workflow files. [More...](d3plot-workflow-class.md#Workflow_details)
...
* [ModelIdFromIndex](d3plot-workflow-class.md#Workflow::ModelIdFromIndex)(model\_index*[integer]*, workflow\_name (optional)*[string]*)
* [ModelUnitSystemFromIndex](d3plot-workflow-class.md#Workflow::ModelUnitSystemFromIndex)(model\_index*[integer]*, workflow\_name (optional)*[string]*)
* [ModelUserDataBuildFromIndex](d3plot-workflow-class.md#Workflow::ModelUserDataBuildFromIndex)(model\_index*[integer]*, workflow\_name (optional)*[string]*)
* [ModelUserDataFromIndex](d3plot-workflow-class.md#Workflow::ModelUserDataFromIndex)(model\_index*[integer]*, workflow\_name (optional)*[string]*)
* [ModelUserDataProgramFromIndex](d3plot-workflow-class.md#Workflow::ModelUserDataProgramFromIndex)(model\_index*[integer]*, workflow\_name (optional)*[string]*)
* [ModelUserDataVersionFromIndex](d3plot-workflow-class.md#Workflow::ModelUserDataVersionFromIndex)(model\_index*[integer]*, workflow\_name (optional)*[string]*)
* [NumberOfSelectedModels](d3plot-workflow-class.md#Workflow::NumberOfSelectedModels)(workflow\_name (optional)*[string]*)
* [Refresh](d3plot-workflow-class.md#Workflow::Refresh)()
* [WorkflowDefinitionFilename](d3plot-workflow-class.md#Workflow::WorkflowDefinitionFilename)(workflow\_name (optional)*[string]*)
* [WriteToFile](d3plot-workflow-class.md#Workflow::WriteToFile)(user\_data*[object]*, output\_filename*[string]*, workflow\_definition\_filename*[string]*, extra (optional)*[object]*)
...
Description<br>Returns the unit system of a model selected by the user by index (starting at 0). Will be [Workflow.UNIT_SYSTEM_NONE](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_NONE) or [Workflow.UNIT_SYSTEM_U1](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U1) or [Workflow.UNIT_SYSTEM_U2](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U2) or [Workflow.UNIT_SYSTEM_U3](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U3) or [Workflow.UNIT_SYSTEM_U4](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U4) or [Workflow.UNIT_SYSTEM_U5](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U5) or [Workflow.UNIT_SYSTEM_U6](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U6) |
| --- |
...
| --- | --- | --- |
| model\_unit\_system (optional) | integer | The model unit system. Can be [Workflow.UNIT_SYSTEM_NONE](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_NONE) or [Workflow.UNIT_SYSTEM_U1](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U1) or [Workflow.UNIT_SYSTEM_U2](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U2) or [Workflow.UNIT_SYSTEM_U3](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U3) or [Workflow.UNIT_SYSTEM_U4](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U4) or [Workflow.UNIT_SYSTEM_U5](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U5) or [Workflow.UNIT_SYSTEM_U6](d3plot-workflow-class.md#Workflow.UNIT_SYSTEM_U6) |
