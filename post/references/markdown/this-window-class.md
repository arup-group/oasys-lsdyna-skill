...
The Window class allows you to create windows for a graphical user interface. [More...](this-window-class.md#Window_details)
...
* [BottomBorder](this-window-class.md#Window::BottomBorder)()
* [BuildGUIFromString](this-window-class.md#Window::BuildGUIFromString)(guistring*[string]*)
* [EndLoop](this-window-class.md#Window::EndLoop)()
* [Error](this-window-class.md#Window::Error)(title*[string]*, error*[string]*, buttons (optional)*[constant]*)
* [GetDirectory](this-window-class.md#Window::GetDirectory)(initial (optional)*[string]*)
* [GetFile](this-window-class.md#Window::GetFile)(extension (optional)*[string]*, save (optional)*[boolean]*, initial (optional)*[string]*)
* [GetFilename](this-window-class.md#Window::GetFilename)(title*[string]*, message*[string]*, extension (optional)*[string]*, initial (optional)*[string]*, save (optional)*[boolean]*)
* [GetFiles](this-window-class.md#Window::GetFiles)(extension (optional)*[string]*)
* [GetInteger](this-window-class.md#Window::GetInteger)(title*[string]*, message*[string]*, initial (optional)*[integer]*)
* [GetNumber](this-window-class.md#Window::GetNumber)(title*[string]*, message*[string]*, initial (optional)*[real]*)
* [GetPassword](this-window-class.md#Window::GetPassword)(title*[string]*, message*[string]*)
* [GetString](this-window-class.md#Window::GetString)(title*[string]*, message*[string]*, initial (optional)*[string]*)
* [Information](this-window-class.md#Window::Information)(title*[string]*, info*[string]*, buttons (optional)*[constant]*)
* [MasterResolution](this-window-class.md#Window::MasterResolution)()
* [Message](this-window-class.md#Window::Message)(title*[string]*, message*[string]*, buttons (optional)*[constant]*)
* [MiddleBorder](this-window-class.md#Window::MiddleBorder)()
* [Question](this-window-class.md#Window::Question)(title*[string]*, question*[string]*, buttons (optional)*[constant]*)
* [RightBorder](this-window-class.md#Window::RightBorder)()
* [StartLoop](this-window-class.md#Window::StartLoop)()
* [Theme](this-window-class.md#Window::Theme)(theme (optional)*[constant]*)
* [TopBorder](this-window-class.md#Window::TopBorder)()
* [UpdateGUI](this-window-class.md#Window::UpdateGUI)()
* [Warning](this-window-class.md#Window::Warning)(title*[string]*, warning*[string]*, buttons (optional)*[constant]*)

## Member functions

* [Delete](this-window-class.md#Window::Delete)()
* [Hide](this-window-class.md#Window::Hide)()
* [Recompute](this-window-class.md#Window::Recompute)()
* [Redraw](this-window-class.md#Window::Redraw)()
* [Show](this-window-class.md#Window::Show)(modal (optional)*[boolean]*)
...
| Window.NONMODAL | Allow [Window.Error](this-window-class.md#Window::Error), [Window.Question](this-window-class.md#Window::Question), [Window.Warning](this-window-class.md#Window::Warning) etc windows to be non modal |
...
| maxWidgets (read only) | integer | The maximum number of widgets that can be made in this window. This can be changed **before** the window is created by using [Options.max_widgets](this-options-class.md#max_widgets). Also see [totalWidgets](this-window-class.md#totalWidgets) |
...
| onHide | function | Function to call when a Window is hidden by calling [Hide()](this-window-class.md#Window::Hide). This may be useful to ensure that certain actions are done after the window is hidden. The Window object is accessible in the function using the 'this' keyword. <br>To unset the function set the property to null. |
| resize | constant | Window resizing. By default when a Window is shown it is allowed to resize on all sides (left, right, top and bottom) to try to make enough room to show the [Widgets](this-widget-class.md). The behaviour can be changed by using this property. It can be any combination (bitwise OR) of [Window.LEFT](this-window-class.md#Window.LEFT), [Window.RIGHT](this-window-class.md#Window.RIGHT), [Window.TOP](this-window-class.md#Window.TOP) or [Window.BOTTOM](this-window-class.md#Window.BOTTOM) or 0. In addition [Window.REDUCE](this-window-class.md#Window.REDUCE) can also be added to allow the window to reduce in size when resizing. Note that when [Window.Show](this-window-class.md#Window::Show) is called this property is set to 0 (i.e. not to resize on any side). |
...
| totalWidgets (read only) | integer | The total number of widgets that have been made in this window. This can be changed **before** the window is created by using [Options.max_widgets](this-options-class.md#max_widgets). Also see [maxWidgets](this-window-class.md#maxWidgets) |
| width | real | width of window |

| Detailed Description<br>The Window class allows you to make windows that you can place<br>[Widgets](this-widget-class.md) in to create a graphical user interface.<br>The Widget class also gives a number of static methods for convenience. e.g.<br>[Window.GetInteger()](this-window-class.md#Window::GetInteger).<br>The following very simple example displays some text in a window with a button that unmaps the window when<br>it is pressed and the user confirms that they want to exit.<br> |
| --- |
...
Description<br>Create a new [Window](this-window-class.md) object. |
| --- |
...
| Returns
<br>[Window](this-window-class.md) object<br>
Return type
<br>Window |
| --- |
...
Description<br>Deletes the window from T/HIS and returns any memory/resources used for the window.<br>**This function should not normally need to be called**. However, in exceptional circumstances if a script<br>recreates windows many times T/HIS may run out of USER objects on Microsoft Windows because of the way T/HIS creates and shows windows. To avoid this problem this method can be used to force T/HIS to return the resources<br>for a window. **Do not use the Window object after calling this method**. |
| --- |
...
| EndLoop() [static]
Description<br>Ends an event loop started by [Window.StartLoop()](this-window-class.md#Window::StartLoop) |
| --- |
...
| Example
<br>To end a blocking event loop started by [Window.StartLoop()](this-window-class.md#Window::StartLoop):<br>
```
Window.EndLoop();
```
 |
...
Error message to show in window. The maximum number of lines that can be shown is controlled by the [Options.max_window_lines](this-options-class.md#max_window_lines) option.

* buttons (optional) (constant)
 
The buttons to use. Can be bitwise OR of [Window.OK](this-window-class.md#Window.OK), [Window.CANCEL](this-window-class.md#Window.CANCEL), [Window.YES](this-window-class.md#Window.YES) or [Window.NO](this-window-class.md#Window.NO). If this is omitted an OK button will be used. By default the window will be modal. If [Window.NONMODAL](this-window-class.md#Window.NONMODAL) is also given the window will be non-modal instead.
...
Description<br>Map a file selector box allowing you to choose a file. See also [Window.GetFiles()](this-window-class.md#Window::GetFiles) and [Window.GetFilename()](this-window-class.md#Window::GetFilename). |
| --- |
...
Description<br>Map a window allowing you to input a filename (or select it using a file selector). OK and Cancel buttons are shown. See also [Window.GetFile()](this-window-class.md#Window::GetFile). |
| --- |
...
Description<br>Map a file selector box allowing you to choose multiple files. See also [Window.GetFile()](this-window-class.md#Window::GetFile) and [Window.GetFilename()](this-window-class.md#Window::GetFilename). |
| --- |
...
Description<br>Map a window allowing you to input a password. OK and Cancel buttons are shown.<br> This is identical to [Window.GetString](this-window-class.md#Window::GetString) except the string is hidden and no initial value can be given. |
| --- |
...
Description<br>Hides (unmaps) the window. Also see the Window [onHide](this-window-class.md#onHide) property. |
| --- |
...
Information to show in window. The maximum number of lines that can be shown is controlled by the [Options.max_window_lines](this-options-class.md#max_window_lines) option.
...
Message to show in window. The maximum number of lines that can be shown is controlled by the [Options.max_window_lines](this-options-class.md#max_window_lines) option.
...
Question to show in window. The maximum number of lines that can be shown is controlled by the [Options.max_window_lines](this-options-class.md#max_window_lines) option.

* buttons (optional) (constant)
 
The buttons to use. Can be bitwise OR of [Window.OK](this-window-class.md#Window.OK), [Window.CANCEL](this-window-class.md#Window.CANCEL), [Window.YES](this-window-class.md#Window.YES) or [Window.NO](this-window-class.md#Window.NO). If this is omitted Yes and No button will be used. By default the window will be modal. If [Window.NONMODAL](this-window-class.md#Window.NONMODAL) is also given the window will be non-modal instead.
...
Description<br>Recomputes the positions of widgets in the window. If you have [static](this-widget-class.md#Widget::Static) widgets and 'normal' widgets in a window and you show and/or hide widgets the window needs to be recomputed to refresh the graphics, scroll bars etc. Calling this method will recompute and redraw the window. |
| --- |
...
Description<br>Redraws the window. Sometimes if you [show](this-widget-class.md#Widget::Show), [hide](this-widget-class.md#Widget::Hide) or draw graphics on [widgets](this-widget-class.md) the window needs to be redrawn to refresh the graphics. Calling this method will redraw the window refreshing the graphics. |
| --- |
...
w.Show();
```
<br><br>To show window w allowing the user to use other functions in T/HIS:<br>
```
w.Show(false);
```
 |
...
If it is provided it is used to set the current theme. Can be either [Window.USE_OLD_UI_JS](this-window-class.md#Window.USE_OLD_UI_JS), [Window.THEME_CURRENT](this-window-class.md#Window.THEME_CURRENT), [Window.THEME_DARK](this-window-class.md#Window.THEME_DARK), [Window.THEME_LIGHT](this-window-class.md#Window.THEME_LIGHT), [Window.THEME_CLASSIC](this-window-class.md#Window.THEME_CLASSIC).

| Returns
<br>Integer. When getting the theme one of: [Window.USE_OLD_UI_JS](this-window-class.md#Window.USE_OLD_UI_JS), [Window.THEME_DARK](this-window-class.md#Window.THEME_DARK), [Window.THEME_LIGHT](this-window-class.md#Window.THEME_LIGHT), [Window.THEME_CLASSIC](this-window-class.md#Window.THEME_CLASSIC)<br>
Return type
<br>Number |
| --- |
...
| TopBorder() [static]
Description<br>Returns the vertical position of the top border (in range 0-1). This can be used to help position windows on the screen. This is no longer used in T/HIS and will always be 1 but is left for backwards compatibility. |
| --- |
...
Warning message to show in window. The maximum number of lines that can be shown is controlled by the [Options.max_window_lines](this-options-class.md#max_window_lines) option.
