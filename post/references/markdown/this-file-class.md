...
The File class allows you to read and write text files. [More...](this-file-class.md#File_details)
...
* [Copy](this-file-class.md#File::Copy)(source*[string]*, dest*[string]*)
* [Delete](this-file-class.md#File::Delete)(filename*[string]*)
* [DriveMapFilename](this-file-class.md#File::DriveMapFilename)(filename*[string]*, format*[constant]*)
* [Exists](this-file-class.md#File::Exists)(filename*[string]*)
* [FindFiles](this-file-class.md#File::FindFiles)(directory*[string]*, type (optional)*[constant]*)
* [Get](this-file-class.md#File::Get)(url*[string]*, filename*[string]*, options (optional)*[object]*)
* [IsAbsolute](this-file-class.md#File::IsAbsolute)(filename*[string]*)
* [IsDirectory](this-file-class.md#File::IsDirectory)(filename*[string]*)
* [IsFile](this-file-class.md#File::IsFile)(filename*[string]*)
* [IsReadable](this-file-class.md#File::IsReadable)(filename*[string]*)
* [IsWritable](this-file-class.md#File::IsWritable)(filename*[string]*)
* [Mkdir](this-file-class.md#File::Mkdir)(directory*[string]*)
* [Mktemp](this-file-class.md#File::Mktemp)()
* [Proxy](this-file-class.md#File::Proxy)(name*[string]*)
* [ProxyPassword](this-file-class.md#File::ProxyPassword)(name*[string]*)
* [ProxyUsername](this-file-class.md#File::ProxyUsername)(username*[string]*)
* [ReadCSV](this-file-class.md#File::ReadCSV)(filename*[string]*, delimiter (optional)*[string]*, comment (optional)*[string]*)
* [Rename](this-file-class.md#File::Rename)(oldname*[string]*, newname*[string]*)
* [Size](this-file-class.md#File::Size)(filename*[string]*)
* [Upload](this-file-class.md#File::Upload)(filename*[string]*, url*[string]*, options (optional)*[object]*)

## Member functions

* [Close](this-file-class.md#File::Close)()
* [FindLineContaining](this-file-class.md#File::FindLineContaining)(contain*[string]*)
* [FindLineStarting](this-file-class.md#File::FindLineStarting)(start*[string]*)
* [Flush](this-file-class.md#File::Flush)()
* [ReadAll](this-file-class.md#File::ReadAll)()
* [ReadArrayBuffer](this-file-class.md#File::ReadArrayBuffer)(length (optional)*[integer]*)
* [ReadChar](this-file-class.md#File::ReadChar)()
* [ReadLine](this-file-class.md#File::ReadLine)()
* [ReadLongLine](this-file-class.md#File::ReadLongLine)()
* [Seek](this-file-class.md#File::Seek)(offset*[integer]*, origin (optional)*[constant]*)
* [Tell](this-file-class.md#File::Tell)()
* [Write](this-file-class.md#File::Write)(string*[Any valid javascript type]*)
* [WriteArrayBuffer](this-file-class.md#File::WriteArrayBuffer)(buffer*[[ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects)]*, length (optional)*[integer]*)
* [Writeln](this-file-class.md#File::Writeln)(string*[Any valid javascript type]*)
...
| mode (read only) | constant | Mode the file was opened with ([File.READ](this-file-class.md#File.READ), [File.WRITE](this-file-class.md#File.WRITE) etc) |
...
Description<br>Create a new [File](this-file-class.md) object for reading and writing text files. |
| --- |
...
Filename of the file you want to read/write. If reading, the file must exist. If writing, the file will be overwritten (if it exists) if mode is File.WRITE, or if mode is File.APPEND it will be appended to if it exists, or created if it does not.
 When reading a file the filename can also be a URL (uniform resource locator) in which case the file will be read from the remote site. See [File.Get()](this-file-class.md#File::Get) for more details on the format of the URL.

* mode (constant)
 
The mode to open the file with. Can be [File.READ](this-file-class.md#File.READ), [File.WRITE](this-file-class.md#File.WRITE) or [File.APPEND](this-file-class.md#File.APPEND). For [File.WRITE](this-file-class.md#File.WRITE) or [File.APPEND](this-file-class.md#File.APPEND) it can also be ORed with [File.BINARY](this-file-class.md#File.BINARY) if required. By default text is read and written as ASCII. To read/write text in utf-8 mode can also be ORed with [File.UTF8](this-file-class.md#File.UTF8) if required.

| Returns
<br>[File](this-file-class.md) object<br>
Return type
<br>File |
| --- |
...
Description<br>Close a file opened by a [File](this-file-class.md) object. |
| --- |
...
| Example
<br>To close [File](this-file-class.md) object f.<br>
```
f.Close();
```
 |
...
The format for the file/directory name. Can be [Include.NATIVE](this-include-class.md#Include.NATIVE), [Include.UNIX](this-include-class.md#Include.UNIX) or [Include.WINDOWS](this-include-class.md#Include.WINDOWS)
...
| Example
<br>If T/HIS has drive S: mapped to "/data" (by using the primer\*drive\_s, this\*drive\_s, d3plot\*drive\_s or oasys\*drive\_s preference)<br>
```
...
Description<br>Check if a file exists. See also [File.IsDirectory()](this-file-class.md#File::IsDirectory) and See also [File.IsFile()](this-file-class.md#File::IsFile). |
| --- |
...
Type of things to find. Can be bitwise OR of [File.FILE](this-file-class.md) and [File.DIRECTORY](this-file-class.md). If omitted only files will be returned.
...
| Example
<br>Loop, reading lines from [File](this-file-class.md) object f which contain 'example'.<br>
```
...
| Example
<br>Loop, reading lines from [File](this-file-class.md) object f which start 'example'.<br>
```
...
Description<br>Flushes a file opened for writing by a [File](this-file-class.md) object. |
| --- |
...
| Example
<br>To flush [File](this-file-class.md) object f.<br>
```
f.Flush();
```
 |
...
Description<br>Get a file from a remote location. See also [File.Proxy()](this-file-class.md#File::Proxy), [File.ProxyPassword()](this-file-class.md#File::ProxyPassword) and [File.ProxyUsername()](this-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Check if a filename is a directory. See also [File.Exists()](this-file-class.md#File::Exists), [File.IsFile()](this-file-class.md#File::IsFile), [File.IsReadable()](this-file-class.md#File::IsReadable) and [File.IsWritable()](this-file-class.md#File::IsWritable). |
| --- |
...
Description<br>Check if a filename is a file. See also [File.Exists()](this-file-class.md#File::Exists), [File.IsDirectory()](this-file-class.md#File::IsDirectory), [File.IsReadable()](this-file-class.md#File::IsReadable) and [File.IsWritable()](this-file-class.md#File::IsWritable). |
| --- |
...
Description<br>Check if a filename has read permissions. See also [File.Exists()](this-file-class.md#File::Exists), [File.IsDirectory()](this-file-class.md#File::IsDirectory) and [File.IsWritable()](this-file-class.md#File::IsWritable). |
| --- |
...
Description<br>Check if a filename has write permissions. If *filename* exists and it is a file then it is checked to see if it can be opened with write (File.APPEND permissions). If *filename* exists and it is a directory<br>then the directory is checked for write permission (can files be created in the directory).<br>If *filename* does not exist then it is assumed to be a file and is checked to see if it can be opened for writing (File.WRITE permissions). See also [File.Exists()](this-file-class.md#File::Exists), [File.IsDirectory()](this-file-class.md#File::IsDirectory) and [File.IsReadable()](this-file-class.md#File::IsReadable). |
| --- |
...
Description<br>Set a proxy for files opened by http, ftp etc. See also [File.Get()](this-file-class.md#File::Get), [File.ProxyPassword()](this-file-class.md#File::ProxyPassword) and [File.ProxyUsername()](this-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Set a proxy password for files opened by http, ftp etc. See also [File.Get()](this-file-class.md#File::Get), [File.Proxy()](this-file-class.md#File::Proxy) and [File.ProxyUsername()](this-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Set a proxy username for files opened by http, ftp etc. See also [File.Get()](this-file-class.md#File::Get), [File.Proxy()](this-file-class.md#File::Proxy) and [File.ProxyPassword()](this-file-class.md#File::ProxyPassword). |
| --- |
...
Description<br>Reads **all** the remaining characters from a file opened for reading by a [File](this-file-class.md) object. As this function can read the entire file as a string be careful when reading large files as it will consume large amounts of memory. |
| --- |
...
| Example
<br>Read all characters from [File](this-file-class.md) object f.<br>
```
 var c = f.ReadAll();
```
 |
...
| Example
<br>To read data as 32bit unsigned integers from [File](this-file-class.md) object f.<br>
```
...
Description<br>Reads a single character from a file opened for reading by a [File](this-file-class.md) object. |
| --- |
...
| Example
<br>Loop, reading characters from [File](this-file-class.md) object f.<br>
```
...
| Example
<br>Loop, reading lines from [File](this-file-class.md) object f.<br>
```
...
Description<br>Reads a line from a file opened for reading by a [File](this-file-class.md) object. The line can be any length. If your file has lines shorter than 512 characters then you may want to use [ReadLine](this-file-class.md#File::ReadLine) instead which is faster. |
| --- |
...
Description<br>Set the current position for reading or writing in a [File](this-file-class.md) object. |
| --- |
...
Origin for offset. Must be one of [File.START](this-file-class.md#File.START), [File.END](this-file-class.md#File.END) or [File.CURRENT](this-file-class.md#File.CURRENT). If omitted [File.START](this-file-class.md#File.START) will be used.
...
| Example
<br>To seek to the end of [File](this-file-class.md) f:<br>
```
f.Seek(0, File.END);
```
<br><br>To seek to the beginning of [File](this-file-class.md) f:<br>
```
f.Seek(0, File.START);
```
<br><br>To move forward 10 characters in [File](this-file-class.md) f:<br>
```
...
Description<br>Return the current file position for a [File](this-file-class.md) object.<br>Note that on Windows when reading files if the file is not opened with [File.BINARY](this-file-class.md#File.BINARY)<br>this may not return the correct file position for files with unix line endings. |
| --- |
...
| Example
<br>To get the current file position for [File](this-file-class.md) f:<br>
```
var pos = f.Tell();
```
 |
...
Description<br>Uploads a file to a remote location. See also [File.Proxy()](this-file-class.md#File::Proxy), [File.ProxyPassword()](this-file-class.md#File::ProxyPassword) and [File.ProxyUsername()](this-file-class.md#File::ProxyUsername). |
| --- |
...
Description<br>Write a string to a file opened for writing by a [File](this-file-class.md) object. **Note that a carriage return is not added**. |
| --- |
...
| Example
<br>To write string "Hello, world!" to [File](this-file-class.md) object f<br>
```
f.Write("Hello, world!\n");
```
<br>To write the title of model m to [File](this-file-class.md) object f<br>
```
...
| Example
<br>To write [ArrayBuffer](https://262.ecma-international.org/6.0/#sec-arraybuffer-objects) ab to [File](this-file-class.md) object f.<br>
```
...
Description<br>Write a string to a file opened for writing by a [File](this-file-class.md) object **adding a carriage return**. |
| --- |
...
| Example
<br>To write string "Hello, world!" to [File](this-file-class.md) object f automatically adding a carriage return<br>
```
f.Writeln("Hello, world!");
```
<br>To write the title of model m to [File](this-file-class.md) object f automatically adding a carriage return<br>
```
