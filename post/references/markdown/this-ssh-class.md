...
The Ssh class allows you to connect to a remote computer using ssh, scp and sftp commands. [More...](this-ssh-class.md#Ssh_details)
...
* [AuthenticateWithPassword](this-ssh-class.md#Ssh::AuthenticateWithPassword)(password*[string]*)
* [AuthenticateWithPublicKey](this-ssh-class.md#Ssh::AuthenticateWithPublicKey)(passphrase (optional)*[string]*)
* [Execute](this-ssh-class.md#Ssh::Execute)(data*[object]*)
* [Get](this-ssh-class.md#Ssh::Get)(remote*[string]*, local*[string]*)
* [Put](this-ssh-class.md#Ssh::Put)(remote*[string]*, local*[string]*)
* [SftpGet](this-ssh-class.md#Ssh::SftpGet)(remote*[string]*, local*[string]*)
* [SftpList](this-ssh-class.md#Ssh::SftpList)(remote*[string]*)
* [SftpMkdir](this-ssh-class.md#Ssh::SftpMkdir)(remote*[string]*, mode*[constant]*)
* [SftpPut](this-ssh-class.md#Ssh::SftpPut)(remote*[string]*, local*[string]*)
* [SftpRmdir](this-ssh-class.md#Ssh::SftpRmdir)(remote*[string]*)
...
| Returns
<br>[Ssh](this-ssh-class.md) object<br>
Return type
<br>Ssh |
| --- |
...
| info | constant | Bitwise information for the file/directory. See the [permissions](this-ssh-class.md#Ssh_permissions_constants), [file types](this-ssh-class.md#Ssh_file_types_constants) and [file bits](this-ssh-class.md#Ssh_file_bits_constants) constants |
...
The mode/permissions for the directory. See the [permissions](this-ssh-class.md#Ssh_permissions_constants) constants for details.
