...
- `../shared/python-api/d3plot.md`
- `../shared/python-api/t-his.md`
- `../shared/python-api/reporter.md`

For common Python API setup and behaviour, consult:

- `../shared/python-api/preamble.md`
- `../shared/python-api/grpc-connection.md`
- `../shared/python-api/python-modules.md`
